 ...
 * Open up a **CLI terminal** > _Change_ the directory to the download location
   * **Example**: `cd /home/user/Downloads/reddington-Master`
 * Type the following commands:
  ```
  chmod +x reddington.py  
  python3 ./reddington.py
  ```
...
The generator will then go through some dialogue before printing a reddington quote.    
